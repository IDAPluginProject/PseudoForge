...
4. Offline CLI
   ...
   - `tools/kernel_corpus/` provides the consumer-side Kernel Corpus pack layer: SQLite builder, read-only query CLI, stdio MCP server, lifecycle tracer, subsystem atlas generator, process/thread ontologies, and the `kernel-corpus-analysis` skill
